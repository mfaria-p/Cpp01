...
{
    //This declares an array of 4 pointers to member functions of the Harl class. 
    //(Harl::*) indicates that the pointers are to member functions of the Harl class.
    //complain[4] declares an array named complain with 4 elements.
    //(void) indicates that the member functions take no parameters.
